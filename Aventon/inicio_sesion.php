            ...
            <h1><img src="Logo.jpg" alt="imagen no disponible" height="55"><font size="8" face="Univers-Light-Normal">   Aventon</font></h1>
                ...
                <form action="registrar.php" method="post" class="form-register">
                    ...
                    <div class="contenedor-inputs">
                        ...
                        <input type="submit" align="middle" value="Iniciar sesión" font-color="#f17376" class="boton_registro">
                        <p class="form_link">¿No posee una cuenta registrada? <a href="index.php">Ingresa aqui</a></p>
                    </div>
            </form>
